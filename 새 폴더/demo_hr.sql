...
select count(employee_id) as employee카운터, (select count(department_id) from departments)as department카운터
from employees;
...
from employees , departments, jobs , locations...귀찮

where city = 'Toronto';


-- 교과서 1번
select job_id , hire_date , last_name
from employees
